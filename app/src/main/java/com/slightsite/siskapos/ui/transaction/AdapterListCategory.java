...
public class AdapterListCategory extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterListCategory(Context context, List<ProductCategory> items) {
        this.items = items;
        ctx = context;
    }
